...
public:
    CMainParams() {
        ...
        consensus.nMinimumChainWork = uint256S("0x0000000000000000000000000000000000000000000176b5dd8e00cb17b97737");

        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x000000000002e13479422a602499ceff5699ae3bb21bc5ebf2b12257d3da7b4e"); //308971
        ...
        vSeeds.emplace_back("seed1.htmlcoin.com", false); // mainnet
        vSeeds.emplace_back("seed2.htmlcoin.com", false); // mainnet
        vSeeds.emplace_back("seed3.htmlcoin.com", false); // mainnet
        vSeeds.emplace_back("seed4.htmlcoin.com", false); // mainnet
        ...
        chainTxData = ChainTxData{
            ...
            1530019875, // * UNIX timestamp of last known number of transactions
            549117, // * total number of transactions between genesis and that timestamp
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed1.htmlcoin.com", false);
