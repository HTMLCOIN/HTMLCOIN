...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("html1.bushstar.co.uk", "html2.bushstar.co.uk", false)); // Qtum mainnet
...
public:
    CTestNetParams() {
        ...
        vSeeds.push_back(CDNSSeedData("html1-testnet.bushstar.co.uk", "html2-testnet.bushstar.co.uk", true));
