...
UniValue getnewaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() > 2)
        throw std::runtime_error(
            ...
            "\nReturns a new HTMLCOIN address for receiving payments.\n"
            ...
            "\nResult:\n"
            "\"address\"    (string) The new htmlcoin address\n"
            "\nExamples:\n"
...
UniValue getaccountaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "\nDEPRECATED. Returns the current HTMLCOIN address for receiving payments to this account.\n"
            "\nArguments:\n"
            "1. \"account\"       (string, required) The account name for the address. It can also be set to the empty string \"\" to represent the default account. The account does not need to exist, it will be created and a new address created  if there is no account by the given name.\n"
            "\nResult:\n"
            "\"address\"          (string) The account htmlcoin address\n"
            "\nExamples:\n"
...
UniValue getrawchangeaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() > 1)
        throw std::runtime_error(
            ...
            "\nReturns a new HTMLCOIN address, for receiving change.\n"
...
UniValue setaccount(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 2)
        throw std::runtime_error(
            ...
            "\nArguments:\n"
            "1. \"address\"         (string, required) The htmlcoin address to be associated with an account.\n"
            "2. \"account\"         (string, required) The account to assign the address to.\n"
            "\nExamples:\n"
            + HelpExampleCli("setaccount", "\"HpT9T7cAWwvPS8EEjJ2tt3WWFncctCpya8\" \"tabby\"")
            + HelpExampleRpc("setaccount", "\"HpT9T7cAWwvPS8EEjJ2tt3WWFncctCpya8\", \"tabby\"")
        );
    ...
    if (!IsValidDestination(dest)) {
        throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "Invalid HTMLCOIN address");
    }
...
UniValue getaccount(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "\nArguments:\n"
            "1. \"address\"         (string, required) The htmlcoin address for account lookup.\n"
            "\nResult:\n"
            "\"accountname\"        (string) the account address\n"
            "\nExamples:\n"
            + HelpExampleCli("getaccount", "\"HpT9T7cAWwvPS8EEjJ2tt3WWFncctCpya8\"")
            + HelpExampleRpc("getaccount", "\"HpT9T7cAWwvPS8EEjJ2tt3WWFncctCpya8\"")
        );
...
UniValue getaddressesbyaccount(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "  \"address\"         (string) a htmlcoin address associated with the given account\n"
            "  ,...\n"
            "]\n"
            "\nExamples:\n"
...
UniValue sendtoaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 10)
        throw std::runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("sendtoaddress", "\"HfWvNMhby9qi69ea5k5qUaAyJzit3d5p6u\" 0.1")
            + HelpExampleCli("sendtoaddress", "\"HfWvNMhby9qi69ea5k5qUaAyJzit3d5p6u\" 0.1 \"donation\" \"seans outpost\"")
            + HelpExampleCli("sendtoaddress", "\"HfWvNMhby9qi69ea5k5qUaAyJzit3d5p6u\" 0.1 \"\" \"\" true")
            + HelpExampleCli("sendtoaddress", "\"HfWvNMhby9qi69ea5k5qUaAyJzit3d5p6u\", 0.1, \"donation\", \"seans outpost\", false, null, null, \"\", \"Hn4EummnZbChwC7zskeJk4SxwYXCCqUGMo\", true")
            + HelpExampleRpc("sendtoaddress", "\"HfWvNMhby9qi69ea5k5qUaAyJzit3d5p6u\", 0.1, \"donation\", \"seans outpost\"")
            + HelpExampleRpc("sendtoaddress", "\"HfWvNMhby9qi69ea5k5qUaAyJzit3d5p6u\", 0.1, \"donation\", \"seans outpost\", false, null, null, \"\", \"Hn4EummnZbChwC7zskeJk4SxwYXCCqUGMo\", true")
        );
...
UniValue signmessage(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 2)
        throw std::runtime_error(
            ...
            + HelpRequiringPassphrase(pwallet) + "\n"
            "\nArguments:\n"
            "1. \"address\"         (string, required) The htmlcoin address to use for the private key.\n"
...
UniValue getreceivedbyaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 2)
        throw std::runtime_error(
            ...
            "\nArguments:\n"
            "1. \"address\"         (string, required) The htmlcoin address for transactions.\n"
...
UniValue sendfrom(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 3 || request.params.size() > 6)
        throw std::runtime_error(
            ...
            "\nDEPRECATED (use sendtoaddress). Sent an amount from an account to a htmlcoin address."
            + HelpRequiringPassphrase(pwallet) + "\n"
            "\nArguments:\n"
            ...
            "                       the spend.\n"
            "2. \"toaddress\"         (string, required) The htmlcoin address to send funds to.\n"
            ...
            + HelpExampleCli("sendfrom", "\"\" \"HfWvNMhby9qi69ea5k5qUaAyJzit3d5p6u\" 0.01") +
            "\nSend 0.01 from the tabby account to the given address, funds must have at least 6 confirmations\n"
            + HelpExampleCli("sendfrom", "\"tabby\" \"HfWvNMhby9qi69ea5k5qUaAyJzit3d5p6u\" 0.01 6 \"donation\" \"seans outpost\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("sendfrom", "\"tabby\", \"HfWvNMhby9qi69ea5k5qUaAyJzit3d5p6u\", 0.01, 6, \"donation\", \"seans outpost\"")
        );
...
UniValue sendmany(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 8)
        throw std::runtime_error(
            ...
            "    {\n"
            "      \"address\":amount   (numeric or string) The htmlcoin address is the key, the numeric amount (can be string) in " + CURRENCY_UNIT + " is the value\n"
            "      ,...\n"
            "    }\n"
            ...
            "                           Those recipients will receive less htmlcoin than you enter in their corresponding amount field.\n"
            ...
            + HelpExampleCli("sendmany", "\"\" \"{\\\"HpT9T7cAWwvPS8EEjJ2tt3WWFncctCpya8\\\":0.01,\\\"HfWvNMhby9qi69ea5k5qUaAyJzit3d5p6u\\\":0.02}\"") +
            "\nSend two amounts to two different addresses setting the confirmation and comment:\n"
            + HelpExampleCli("sendmany", "\"\" \"{\\\"HpT9T7cAWwvPS8EEjJ2tt3WWFncctCpya8\\\":0.01,\\\"HfWvNMhby9qi69ea5k5qUaAyJzit3d5p6u\\\":0.02}\" 6 \"testing\"") +
            "\nSend two amounts to two different addresses, subtract fee from amount:\n"
            + HelpExampleCli("sendmany", "\"\" \"{\\\"HpT9T7cAWwvPS8EEjJ2tt3WWFncctCpya8\\\":0.01,\\\"HfWvNMhby9qi69ea5k5qUaAyJzit3d5p6u\\\":0.02}\" 1 \"\" \"[\\\"HpT9T7cAWwvPS8EEjJ2tt3WWFncctCpya8\\\",\\\"HfWvNMhby9qi69ea5k5qUaAyJzit3d5p6u\\\"]\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("sendmany", "\"\", \"{\\\"HpT9T7cAWwvPS8EEjJ2tt3WWFncctCpya8\\\":0.01,\\\"HfWvNMhby9qi69ea5k5qUaAyJzit3d5p6u\\\":0.02}\", 6, \"testing\"")
        );
    ...
    for (const std::string& name_ : keys) {
        ...
        if (!IsValidDestination(dest)) {
            throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, std::string("Invalid HTMLCOIN address: ") + name_);
        }
...
UniValue sendmanywithdupes(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 5)
        throw std::runtime_error(
            ...
            "\nExamples:\n"
            "\nSend two amounts to two different addresses:\n"
            + HelpExampleCli("sendmanywithdupes", "\"\" \"{\\\"HpT9T7cAWwvPS8EEjJ2tt3WWFncctCpya8\\\":0.01,\\\"HfWvNMhby9qi69ea5k5qUaAyJzit3d5p6u\\\":0.02}\"") +
            "\nSend two amounts to two different addresses setting the confirmation and comment:\n"
            + HelpExampleCli("sendmanywithdupes", "\"\" \"{\\\"HpT9T7cAWwvPS8EEjJ2tt3WWFncctCpya8\\\":0.01,\\\"HfWvNMhby9qi69ea5k5qUaAyJzit3d5p6u\\\":0.02}\" 6 \"testing\"") +
            "\nSend two amounts to two different addresses, subtract fee from amount:\n"
            + HelpExampleCli("sendmanywithdupes", "\"\" \"{\\\"HpT9T7cAWwvPS8EEjJ2tt3WWFncctCpya8\\\":0.01,\\\"HfWvNMhby9qi69ea5k5qUaAyJzit3d5p6u\\\":0.02}\" 1 \"\" \"[\\\"HpT9T7cAWwvPS8EEjJ2tt3WWFncctCpya8\\\",\\\"HfWvNMhby9qi69ea5k5qUaAyJzit3d5p6u\\\"]\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("sendmanywithdupes", "\"\", \"{\\\"HpT9T7cAWwvPS8EEjJ2tt3WWFncctCpya8\\\":0.01,\\\"HfWvNMhby9qi69ea5k5qUaAyJzit3d5p6u\\\":0.02}\", 6, \"testing\"")
        );
...
UniValue addmultisigaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 4) {
        std::string msg = "addmultisigaddress nrequired [\"key\",...] ( \"account\" \"address_type\" )\n"
            ...
            "Each key is a HTMLCOIN address or hex-encoded public key.\n"
            ...
            "2. \"keys\"                         (string, required) A json array of htmlcoin addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"address\"                  (string) htmlcoin address or hex-encoded public key\n"
            "       ...,\n"
            "     ]\n"
            ...
            "\"address\"                         (string) A htmlcoin address associated with the keys.\n"
...
UniValue listtransactions(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() > 4)
        throw std::runtime_error(
            ...
            "    \"address\":\"address\",    (string) The htmlcoin address of the transaction. Not present for \n"
...
UniValue listsinceblock(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() > 4)
        throw std::runtime_error(
            ...
            "    \"address\":\"address\",    (string) The htmlcoin address of the transaction. Not present for move transactions (category = move).\n"
...
UniValue gettransaction(const JSONRPCRequest& request_)
{
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 3)
        throw std::runtime_error(
            ...
            "      \"address\" : \"address\",          (string) The htmlcoin address involved in the transaction\n"
...
UniValue encryptwallet(const JSONRPCRequest& request)
{
    ...
    if (!pwallet->IsCrypted() && (request.fHelp || request.params.size() != 1)) {
        throw std::runtime_error(
            ...
            "\nNow set the passphrase to use the wallet, such as for signing or sending htmlcoin\n"
    ...
    StartShutdown();
    return "wallet encrypted; HTMLCOIN server stopping, restart to run with encrypted wallet. The keypool has been flushed and a new HD seed was generated (if you are using HD). You need to make a new backup.";
}
...
UniValue lockunspent(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 2)
        throw std::runtime_error(
            ...
            "A locked transaction output will not be chosen by automatic coin selection, when spending htmlcoin.\n"
...
UniValue listunspent(const JSONRPCRequest& request)
{
    ...
    if (!request.params[2].isNull()) {
        ...
        for (unsigned int idx = 0; idx < inputs.size(); idx++) {
            ...
            if (!IsValidDestination(dest)) {
                throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, std::string("Invalid HTMLCOIN address: ") + input.get_str());
            }
...
UniValue fundrawtransaction(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 3)
        throw std::runtime_error(
                            ...
                            "   {\n"
                            "     \"changeAddress\"          (string, optional, default pool address) The htmlcoin address to receive the change\n"
    ...
    if (!request.params[1].isNull()) {
      if (request.params[1].type() == UniValue::VBOOL) {
        ...
        if (options.exists("changeAddress")) {
            ...
            if (!IsValidDestination(dest)) {
                throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "changeAddress must be a valid htmlcoin address");
            }
