...
const QString BITCOIN_IPC_PREFIX("htmlcoin:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/htmlcoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/htmlcoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/htmlcoin-paymentrequest";
    ...
    if (startLocalServer)
    {
        ...
        if (!uriServer->listen(name)) {
            ...
            QMessageBox::critical(0, tr("Payment request error"),
                tr("Cannot start htmlcoin: click-to-pay handler"));
        }
        else {
